...
print("Writing make_vanilla_app.py script...")

# Template for app.html in pure Vanilla JS
...
.step-bd{padding:18px;display:block;background:#fff}
...
print("Vanilla CSS template ready.")
