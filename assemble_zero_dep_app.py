...
print("Assembling zero-dependency app.html...")

with open("build_entire_75_hub.py", "r", encoding="utf-8") as f:
    data_code = f.read().split("const MODULES=")[0]
...
body {{ font-family: 'Segoe UI', system-ui, -apple-system, sans-serif; background: #f4f6f9; color: #1a202c; margin: 0; padding: 0; }}
...
print("Zero-dependency app.html generated successfully!")
